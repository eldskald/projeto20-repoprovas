import { insertTest, findByDiscTermCat, findByTeacherCat } from '../repositories/testsRepository';
...
export async function listByTeachers() {
  return await findByTeacherCat();
}